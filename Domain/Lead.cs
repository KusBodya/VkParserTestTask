...
/// <summary>Лид, сформированный из релевантного поста ВКонтакте и доступный через API.</summary>
public class Lead
{
    [Key]
    ...
    [MaxLength(32)]
    public string? PrimaryPhoneE164 { get; set; }
    ...
    /// <summary>Свободная заметка для внутренних комментариев по лиду.</summary>
    [MaxLength(512)]
    ...
    [NotMapped]
    public string? PostUrl => Post?.PostUrl;

    [NotMapped]
    public string? AuthorUrl => Author?.ProfileUrl;
}
